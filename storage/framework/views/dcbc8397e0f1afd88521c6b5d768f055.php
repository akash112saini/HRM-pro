...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="page-title">Welcome back, <?php echo e(Auth::user()->name); ?>!</h1>
                <p class="text-muted">Here's what's happening today.</p>
            </div>
            <div class="d-flex gap-2">
                <a href="<?php echo e(roleRoute('attendance')); ?>" class="btn btn-outline-primary">
                    <i class="bi bi-clock me-2"></i>Attendance
                </a>
                <a href="<?php echo e(roleRoute('leaves')); ?>" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            ...
                            <?php if($todayAttendance): ?>
                                <div class="text-center py-3">
                                    ...
                                    <h4>Present</h4>
                                    <p class="text-muted">
                                        Punched in at <?php echo e(\Carbon\Carbon::parse($todayAttendance->punch_in)->format('h:i A')); ?>

                                        <?php if($todayAttendance->is_late): ?>
                                            <span class="badge bg-warning text-dark ms-2">Late</span>
                                        <?php endif; ?>
                                    </p>
                                    <?php if($todayAttendance->punch_out): ?>
                                        <p class="text-muted">Punched out at
                                            <?php echo e(\Carbon\Carbon::parse($todayAttendance->punch_out)->format('h:i A')); ?></p>
                                    <?php else: ?>
                                        <form action="<?php echo e(roleRoute('attendance.punch-out')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                            ...
                            <?php else: ?>
                                <div class="text-center py-3">
                                    ...
                                    <form action="<?php echo e(roleRoute('attendance.punch-in')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h4 class="mb-0">
                                                <?php echo e($recentPayslips->first() ? number_format($recentPayslips->first()->net_salary) : 'N/A'); ?>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $recentLeaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($leave->start_date->format('d M')); ?> - <?php echo e($leave->end_date->format('d M')); ?>

                                                </td>
                                                <td>
                                                    <span
                                                        class="badge bg-<?php echo e($leave->status === 'approved' ? 'success' : ($leave->status === 'rejected' ? 'danger' : 'warning')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/HR-pro/resources/views/ess/dashboard.blade.php ENDPATH**/ ?>