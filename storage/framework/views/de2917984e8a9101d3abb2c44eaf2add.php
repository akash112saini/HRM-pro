...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(roleRoute('employees.index')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(roleRoute('employees.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/HR-pro/resources/views/employees/create.blade.php ENDPATH**/ ?>