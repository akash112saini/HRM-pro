...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="page-title">Add Salary Structure</h1>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ roleRoute('salary-structures.store') }}" method="POST">
                    @csrf

                    <div class="mb-3">
                        <label for="name" class="form-label">Structure Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                            value="{{ old('name') }}" required placeholder="e.g. Regular Staff Structure">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div id="components-container">
                            <div class="row mb-2 component-row">
                                <div class="col-md-4">
                                    <input type="text" name="components[0][name]" class="form-control"
                                        placeholder="Component Name (e.g. Basic)" required>
                                </div>
                                <div class="col-md-3">
                                    <select name="components[0][type]" class="form-select" required>
                                        <option value="fixed">Fixed Amount</option>
                                        <option value="percentage">Percentage of Basic</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <input type="number" step="0.01" name="components[0][value]" class="form-control"
                                        placeholder="Value" required>
                                </div>
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-outline-danger remove-component" disabled>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-2"></i>Save Structure
                        </button>
                    </div>
                </form>
            </div>
