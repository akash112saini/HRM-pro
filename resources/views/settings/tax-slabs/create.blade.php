...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="page-title">Add Tax Slab</h1>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ roleRoute('tax-slabs.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('financial_year') is-invalid @enderror"
                                ...
                                value="{{ old('financial_year', date('Y') . '-' . (date('Y') + 1)) }}"
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-2"></i>Save Tax Slab
                        </button>
                    </div>
                </form>
            </div>
