...
@section('content')
    <div class="page-header mb-4">
        <h1 class="page-title">Edit Plan: {{ $subscriptionPlan->name }}</h1>
        <p class="text-muted">Modify subscription plan details and features</p>
    </div>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('super-admin.subscription-plans.update', $subscriptionPlan) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="max_employees" class="form-control"
                            value="{{ old('max_employees', $subscriptionPlan->max_employees) }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="max_users" class="form-control"
                            value="{{ old('max_users', $subscriptionPlan->max_users) }}" required>
                    </div>
